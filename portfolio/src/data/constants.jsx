import OptionsPricer from '../images/OptionsPricer.png'
import AlgoViz from '../images/AlgoViz.png'
  ...
  export const projects = [
    {
      ...
      date: "Aug. 2023 - Present",
      description:
        "For the NLP for Financial Markets team within the Financial Services and Innovation Lab, I am using Hugging Face to fine-tune different large language models to better predict company responses to complaints. The model currently predicts company responses with 80% accuracy. This will allow us to obtain the probability a financial complaint will result in compensation, allowing us to predict the outcomes of consumer disputes.",
    ...
    },
    {
      ...
      webapp: "https://christianlindler.github.io/algovisualizer",
    },
  ];
  
  export const TimeLineData = [
    { year: 2012, text: "Started learning to code by learning JS through Khan Academy"},
    { year: 2017, text: "Explored Computer Science through AP Courses and personal projects"},
    { year: 2020, text: "Earned my first software internship as a High Schooler at the Laboratory for Atmospheric and Space Physics at CU Boulder"},
    { year: 2021, text: "Began my Bachelor's in Computer Science at the Georgia Institute of Technology"},
    { year: 2022, text: "Worked as a software engineering intern at USSI"},
    { year: 2023, text: "Selected among a limited number of highly-qualified students for Georgia Tech's joint B.S./M.S. CS program"},
    { year: 2023, text: "Developed Skylar as a Data Science Engineering Intern at CITY Furniture" },
  ];
